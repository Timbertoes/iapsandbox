...
namespace Samples.Purchasing.Core.BuyingConsumables
{
    public class BuyingConsumables : MonoBehaviour, IStoreListener
    {
        ...
        public string goldProductId = "com.witchhuntstudios.iapsandbox.gold1";
        public string diamondProductId = "com.witchhuntstudios.iapsandbox.diamond1";
        ...
        {
            Debug.Log($"Purchasing failed to initialize. Reason: {error}.");
        }
